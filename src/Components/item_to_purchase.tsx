...
const ItemToPurchase = function ({img, name, price, count, countfunc, cookies, setC,cps,cpsf,spec_cps, click_strength, clickf, auto_click}: Props) {
    //const newPrice = price + ((price *0.3)**2)*(count/10);
    const newPrice = price + (price * 0.3) * (count * 0.3) * count
